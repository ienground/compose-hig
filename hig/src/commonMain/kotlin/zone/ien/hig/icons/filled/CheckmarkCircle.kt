...
package zone.ien.hig.icons.filled
...
val CupertinoIcons.Filled.CheckmarkCircle: ImageVector
    get() {
        if (zone.ien.hig.icons.filled._checkmarkCircle != null) {
            return zone.ien.hig.icons.filled._checkmarkCircle!!
        }
        zone.ien.hig.icons.filled._checkmarkCircle =
            Builder(
