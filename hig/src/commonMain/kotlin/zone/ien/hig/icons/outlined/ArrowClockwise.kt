...
package zone.ien.hig.icons.outlined
...
val CupertinoIcons.Outlined.ArrowClockwise: ImageVector
    get() {
        if (zone.ien.hig.icons.outlined._arrowClockwise != null) {
            return zone.ien.hig.icons.outlined._arrowClockwise!!
        }
        zone.ien.hig.icons.outlined._arrowClockwise =
            Builder(
                name = "ArrowClockwise",
