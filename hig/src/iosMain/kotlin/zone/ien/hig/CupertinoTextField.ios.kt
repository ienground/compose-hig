...
internal actual fun KeyboardOptions.enableNativeInput() =
    this
//    copy(platformImeOptions = PlatformImeOptions { usingNativeTextInput(true) }) // TODO: Disabled due to keyboard layout breaking issues when using native input on iOS